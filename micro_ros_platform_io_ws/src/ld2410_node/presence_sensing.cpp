...
std::unique_ptr<RadarLd2410Manager<NUM_SENSORS>> radar_node; //omdat we 2 HARDWARE UART beschikbaar hebben voor radar.. 
...
void setup(void)
{
  ...
  delay(2000); //wait for serial monitor to open
    ...
    radar_node.reset(new RadarLd2410Manager<NUM_SENSORS>("ld2410_manager_node", "ld2410_target_frames", ros_serial_config, 0, 48));
    ...
    radar_node.reset(new RadarLd2410Manager<NUM_SENSORS>("ld2410_manager_node", "ld2410_target_frames", wifi_config, 0, 48));
