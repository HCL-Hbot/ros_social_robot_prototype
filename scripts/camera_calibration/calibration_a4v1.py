...
def main():
    ...
    """
    image_path = "my_photo-5.jpg"  # Pas dit aan naar de juiste afbeelding
    reference_object_width_mm = 297  # Bijvoorbeeld A4-papier breedte (landscape)
    reference_object_distance_mm = 650  # Afstand tot object in mm
